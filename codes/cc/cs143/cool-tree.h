...
public:
   ...
   virtual Class_ copy_Class_() = 0;
    virtual void pre_semant(ClassTable*) = 0;
...
class attr_class;
typedef attr_class* AttrClass;
class method_class;
typedef method_class* MethodClass;
...
public:
   ...
   Class_ copy_Class_();
   void dump(ostream& stream, int n);
    void pre_semant(ClassTable*);
    virtual void semant(ClassTable*);
    AttrClass find_attr(Symbol s);
    MethodClass find_method(Symbol s);
...
typedef class__class* ClassClass;
...
typedef formal_class* FormalClass;
...
typedef branch_class* BranchClass;
